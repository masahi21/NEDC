...
# pressure, temp, humidity, co2, air, radiation counts
plot_jobs = [None, None, None, None, None, None]
...
PGButton = Tkinter.Checkbutton(top, text="Pocket Geiger", variable=varPG, font="Times 25")
# maxdata = Entry(top)
# n_merge = Entry(top)
